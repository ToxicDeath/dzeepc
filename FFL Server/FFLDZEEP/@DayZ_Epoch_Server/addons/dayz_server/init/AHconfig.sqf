...
/*  SUPER ADMIN HERE      */ _SAdmins = ["76561198076860834","76561198029259089","76561198039823778"]; //do not have a , at the end.
/*  BANNED PLAYER HERE    */ _BLOCKED = ["0","0","0"]; //do not have a , at the end.
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "FFL DayZ Epoch"; //do not use " in this text.
...
/*  DebugMonitor TXT      */ _BottomDebug = "FFL-clan.co.za"; //do not use " in this text.
