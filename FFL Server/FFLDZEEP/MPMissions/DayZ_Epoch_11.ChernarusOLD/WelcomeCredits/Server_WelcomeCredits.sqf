...
_role1 = "Welcome to";
_role1names = ["FFL DAYZ EPOCH SERVER"];
_role2 = "Website";
_role2names = ["http://ffl-clan.co.za"];
_role3 = "TeamSpeak";
_role3names = ["152.111.192.232:9290 password - fllwar"];
...
_role5 = "Server Admin";
_role5names = ["Switch", "Killroy", "ToxicDeath_X", "Richard. - add ign here.", "any problems feel free to ask"];
